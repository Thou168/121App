...
import com.example.a121firstapp.Class_Adapter.List_Adapter_Buy_Computer_and_accessories;
import com.example.a121firstapp.Class_Adapter.List_Adapter_Rent_Computer_and_accessories;

public class data_buy_computer_and_accessories extends AppCompatActivity {
    ListView list;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_bar_buy_computer_and_accessories);
        initToolBar();

        List_Adapter_Buy_Computer_and_accessories adapter = new List_Adapter_Buy_Computer_and_accessories(data_buy_computer_and_accessories.this, name,price, imageId);

        list =(ListView)findViewById(R.id.list_buy_computer_and_accessories);
