...
import com.example.a121firstapp.Class_Adapter.List_Adapter_Buy_Vehicle;

public class data_buy_vehicle extends AppCompatActivity {
    ListView list;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_bar_buy_vehicle);
        initToolBar();

        List_Adapter_Buy_Vehicle adapter = new
                List_Adapter_Buy_Vehicle(data_buy_vehicle.this, name,price, imageId);
        list=(ListView)findViewById(R.id.list_buy_vehicle);
