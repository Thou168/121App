...
public class create_loan_request extends AppCompatActivity {
    ...
    EditText etName,etAge,etJob,etIncome,etExpense,etPhone,etAddress,etAmount,etDuration,etPurpose,etStatus;
    ...
    private void EventText() {
        ...
        tvGender.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgGender.setImageResource(R.drawable.icon_circle_null_24);
                } else imgGender.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etAge.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgAge.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgAge.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgAge.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etJob.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgJob.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgJob.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgJob.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etIncome.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgIncome.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgIncome.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgIncome.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etExpense.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgExpense.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgExpense.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgExpense.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etAddress.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgAddress.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgAddress.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgAddress.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etAmount.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgAmount.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgAmount.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgAmount.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etDuration.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgDuration.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgDuration.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgDuration.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etPurpose.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgPurpose.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgPurpose.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgPurpose.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        etStatus.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgStatus.setImageResource(R.drawable.icon_circle_null_24);
                } else if (s.length() < 3) {
                    imgStatus.setImageResource(R.drawable.ic_error_black_24dp);
                } else imgStatus.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        tvStaff.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgStaff.setImageResource(R.drawable.icon_circle_null_24);
                } else imgStaff.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        tvStateID.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgStateID.setImageResource(R.drawable.icon_circle_null_24);
                } else imgStateID.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        tvFamily.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgFamily.setImageResource(R.drawable.icon_circle_null_24);
                } else imgFamily.setImageResource(R.drawable.icon_ok_24px);
            }
        ...
        tvHourse.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() == 0) {
                    imgHourse.setImageResource(R.drawable.icon_circle_null_24);
                } else imgHourse.setImageResource(R.drawable.icon_ok_24px);
            }
