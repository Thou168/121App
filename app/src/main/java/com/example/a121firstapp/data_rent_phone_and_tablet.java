...
public class data_rent_phone_and_tablet extends AppCompatActivity {
    ListView list;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_bar_rent_phone_and_tablet);
        initToolBar();

        List_Adapter_Rent_Phone_and_Tablet adapter = new
                List_Adapter_Rent_Phone_and_Tablet(data_rent_phone_and_tablet.this, name,price, imageId);

        list=(ListView)findViewById(R.id.list_rent_phone_and_tablet);
