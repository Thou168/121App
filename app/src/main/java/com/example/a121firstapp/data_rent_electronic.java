...
public class data_rent_electronic extends AppCompatActivity {
    ListView list;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_bar_rent_electronic);
        initToolBar();

        List_Adapter_Rent_Electronic adapter = new
                List_Adapter_Rent_Electronic(data_rent_electronic.this, name,price, imageId);
        list=(ListView)findViewById(R.id.list_rent_electronic);
