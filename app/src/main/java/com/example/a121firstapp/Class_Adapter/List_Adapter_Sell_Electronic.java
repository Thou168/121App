...
public class List_Adapter_Sell_Electronic extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] name,price;
    private final Integer[] imageId;
    public List_Adapter_Sell_Electronic(Activity context,
                                        String[] name, String[] price, Integer[] imageId) {
        super(context, R.layout.list_sell_electronic, name);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.list_sell_electronic, null, true);
        ...
        ImageView imageSell = (ImageView) rowView.findViewById(R.id.img_sell_electronic);
