...
public class fram_home_buy extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fram_home_buy);
        initToolBar();
    ...
    public void initToolBar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(fram_home_buy.this, "Home", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
