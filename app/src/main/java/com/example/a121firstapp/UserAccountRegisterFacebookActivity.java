...
import com.example.a121firstapp.Class_item.UserAccountLoginActivity;
...
//        profilePictureView = (ProfilePictureView) findViewById(R.id.imagefb);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), UserAccountLoginActivity.class);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(),UserAccountRegistrationActivity.class);
                startActivity(intent);
            }
        });
