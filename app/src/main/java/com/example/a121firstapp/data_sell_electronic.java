...
import com.example.a121firstapp.Class_Adapter.List_Adapter_Sell_Electronic;
import com.example.a121firstapp.Class_Adapter.List_Adapter_Sell_Vehicle;

public class data_sell_electronic extends AppCompatActivity {
    ListView list;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_bar_sell_electronic);
        initToolBar();

        List_Adapter_Sell_Electronic adapter = new
                List_Adapter_Sell_Electronic(data_sell_electronic.this, name,price, imageId);
        list=(ListView)findViewById(R.id.list_sell_electronic);
